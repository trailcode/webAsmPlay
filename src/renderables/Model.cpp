...
namespace
{
	...
	Mesh processMesh(aiMesh *mesh, const aiScene *scene, const string & directory)
    {
        ...
        for(unsigned int i = 0; i < mesh->mNumVertices; i++)
        {
			...
			//cout << "  " << mesh->mColors[0]->r << " " << mesh->mColors[0]->g << " " << mesh->mColors[0]->b << " " << mesh->mColors[0]->a << endl;
...
void Model::processNode(aiNode *node, const aiScene *scene, const string & directory)
{
