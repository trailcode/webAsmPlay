 ...
 ******************************************************************************/
    ...
    onCanvasResize: function(_width, _height) {
      ...
      GLFW.active.x = 0;
      GLFW.active.y = 0;
      GLFW.active.width = Module.ctx.clientWidth;
    ...
    markWindowForRefresh: function(winid) {
      var win = GLFW.WindowFromId(winid);
      if (!win) return;
      if (!win.requestedAnimationFrame) {
        win.requestedAnimationFrame = true;
        Browser.requestAnimationFrame(function() {
          win.requestedAnimationFrame = false;
          Browser.mainLoop.runIter(function() {
            ...
            Runtime.dynCall('vi', win.windowRefreshFunc, [winid]);
          });
        });
      }
    },
 ...
 ******************************************************************************/
  ...
  glfwMarkWindowForRefresh: function(winid) {
    GLFW.markWindowForRefresh(winid);
  },
